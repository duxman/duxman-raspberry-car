...
public interface IBasicoVideo
{
  ...
  public static int TAM_CUADRADO = 32;

  public static double  FOCAL_LENGTH=  2.3;
  public static double  LENS_DISTANCE=  110;
  ...
  public static String COMANDO_VIDEO_DEV_DER = "ls -l /dev/video-der";
  public static String COMANDO_VIDEO_DEV_IZQ = "ls -l /dev/video-izq";
