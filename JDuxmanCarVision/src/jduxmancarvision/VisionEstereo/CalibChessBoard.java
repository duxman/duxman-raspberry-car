...
public class CalibChessBoard
{
    ...
    int flagsCorner = Calib3d.CALIB_CB_ADAPTIVE_THRESH | Calib3d.CALIB_CB_FAST_CHECK | Calib3d.CALIB_CB_NORMALIZE_IMAGE;
    ...
    ArrayList<Mat> objectPoints, imagePoints = new ArrayList();
    ArrayList vCorners;
    ArrayList<Mat> vImg;
    ...
    void calibrate()
    {
        double errReproj = Calib3d.calibrateCamera(objectPoints,imagePoints, vImg.get(0).size(), cameraMatrix, distCoeffs, rvecs, tvecs, flagsCalib);
