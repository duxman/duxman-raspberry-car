...
public class HandDetector
{
    ...
    private static final int IMG_SCALE = 1;  // scaling applied to webcam image
    ...
    private final Point[] tipPts, foldPts;
    private float[] depths;
    private List<Point> fingerTips ;

    // finger identifications
    private List<FingerName> namedFingers;
    ...
    public HandDetector(String hsvFnm, int width, int height)
    {
        ...
        copia = IplImage.create(width / IMG_SCALE, height / IMG_SCALE, 8, 1);   // threshold image
    ...
    public IplImage update(IplImage im)
     ...
     */
    {
        ...
        cvInRangeS(hsvImg, cvScalar(0, 0, 0, 0), cvScalar(180, 255, 85, 0), imgThreshed);
       ...
       /* cvInRangeS(hsvImg, cvScalar(hueLower, satLower, briLower, 0),
        ...
        cvCopy(imgThreshed,copia) ;
        
        CvSeq bigContour = findBiggestContour(copia);
        if (bigContour == null)
        {
            return null;
        }
                
        opencv_core.cvDrawContours(imgThreshed,bigContour,cvScalar(255,0, 0, 0), cvScalar(0,255, 0, 0), 0, 5, 8 );
    ...
    private void labelThumbIndex( List<Point> fingerTips, List<FingerName> nms)
    ...
    private void labelUnknowns(List<FingerName> nms)
    ...
    private void labelPrev(List<FingerName> nms, int i, FingerName name)
    ...
    private void labelFwd(List<FingerName> nms, int i, FingerName name)
    ...
    private boolean usedName(List<FingerName> nms, FingerName name)
